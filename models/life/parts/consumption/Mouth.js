class Mouth extends Part{
    ...
    act(){
        ...
        // Temp replacement to check if biting is inhibiting evolution
        for(let id in Environment.nutrients){
            let nutrient = Environment.nutrients[id];   
            if(withinRadius(nutrient.x, nutrient.y, this.x, this.y, this.radius)){
        ...
        for(let id in Environment.toxins){
            ...
            if(withinRadius(toxin.x, toxin.y, this.x, this.y, this.radius)){
        ...
        //         this.creature.energy -= this.radius*this.radius/10; // Cost to biting
        //     }
        ...
        //     if(!this.open){
        //         this.creature.energy -= this.radius*this.radius/10; // Cost to opening mouth
        //     }
